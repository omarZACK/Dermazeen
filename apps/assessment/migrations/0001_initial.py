    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_name', models.CharField(help_text='Question title.', max_length=40, unique=True)),
                ...
                ('condition_triggers', models.ManyToManyField(help_text='Conditions that trigger this question (e.g. acne -> hormonal questions).', related_name='condition_triggers', to='analysis.skincondition')),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['question_type'], name='assessment__questio_696bc9_idx'),
        ),
        migrations.AddIndex(
            model_name='questiontemplate',
            index=models.Index(fields=['display_order'], name='assessment__display_050934_idx'),
        ),
        migrations.AddIndex(
            model_name='questiontemplate',
            index=models.Index(fields=['is_active'], name='assessment__is_acti_59e953_idx'),
        ),
        migrations.AddIndex(
