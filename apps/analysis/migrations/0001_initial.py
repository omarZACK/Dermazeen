    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confidence_score', models.FloatField(help_text='Overall confidence score for the analysis.', validators=[apps.shared.validators.validate_confidence_score])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('acne', 'Acne'), ('pigmentation', 'Pigmentation'), ('aging', 'Aging Signs'), ('sensitivity', 'Sensitivity'), ('inflammation', 'Inflammation'), ('barrier_damage', 'Barrier Damage'), ('hormonal', 'Hormonal'), ('lifestyle', 'Lifestyle Related'), ('chronic', 'Chronic Conditions'), ('genetic', 'Genetic Related')], help_text='Category under which this condition falls.', max_length=20)),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['category'], name='analysis_sk_categor_9a6062_idx'), models.Index(fields=['is_chronic'], name='analysis_sk_is_chro_106deb_idx'), models.Index(fields=['requires_medical_attention'], name='analysis_sk_require_1598db_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confidence_score', models.FloatField(help_text='Confidence score for the condition detection.', validators=[apps.shared.validators.validate_confidence_score])),
