    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adherence_rate', models.FloatField(default=0.0, help_text='Adherence rate as a percentage (0.0 - 100.0).', validators=[apps.shared.validators.validate_adherence_rate])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mood_rating', models.PositiveIntegerField(blank=True, help_text="User's mood rating for the day (1-10 scale).", null=True, validators=[apps.shared.validators.validate_mood_rating])),
