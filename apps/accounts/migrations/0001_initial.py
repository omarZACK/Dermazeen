    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, error_messages={'unique': 'A user with this phone number already exists.'}, max_length=20, null=True, unique=True, validators=[apps.shared.utils.validators.validate_phone_number], verbose_name='Phone Number')),
