    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reviewed_by', models.ForeignKey(help_text='Staff member who reviewed this recommendation.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='custom_admin.admin')),
            ],
            options={
