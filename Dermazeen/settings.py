"""
Django settings for Dermazeen project.
...
SECRET_KEY = 'django-insecure-ayi-68efu0c1_ii6s-m-0kmgv)8dp7ly%(iqskzrgl8sq^quux'
...
WSGI_APPLICATION = 'Dermazeen.wsgi.application'
